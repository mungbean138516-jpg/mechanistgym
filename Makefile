.PHONY: help install-dev demo runtime-demo runtime-async-demo compile test lint format-check check
...
help:
	...
	@echo "  make runtime-async-demo Run bounded async Task execution"
...
runtime-async-demo:
	PYTHONPATH=src python -m mechanistgym.runtime.async_demo
